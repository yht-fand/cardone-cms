...
<#if (where_and_nq_noticeId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_nq_noticeId_value??)>
${prefixName} `NOTICE_ID` <> :where_and_nq_noticeId_value
<#else>
${prefixName} `NOTICE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_and_like_noticeId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'AND'>
</#if>
<#if (where_and_like_noticeId_value??)>
${prefixName} `NOTICE_ID` <> :where_and_like_noticeId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_eq_noticeId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_eq_noticeId_value??)>
${prefixName} `NOTICE_ID` = :where_or_eq_noticeId_value
<#else>
${prefixName} `NOTICE_ID` IS NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_nq_noticeId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_nq_noticeId_value??)>
${prefixName} `NOTICE_ID` <> :where_or_nq_noticeId_value
<#else>
${prefixName} `NOTICE_ID` IS NOT NULL
</#if>
<#assign prefixName = ''>
</#if>
<#if (where_or_like_noticeId??)>
<#if (prefixName!) != 'WHERE'>
<#assign prefixName = 'OR'>
</#if>
<#if (where_or_like_noticeId_value??)>
${prefixName} `NOTICE_ID` like :where_or_like_noticeId_value
</#if>
<#assign prefixName = ''>
</#if>
<#if (prefixName!) != 'WHERE'>
