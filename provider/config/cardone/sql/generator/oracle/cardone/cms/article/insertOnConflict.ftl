...
<#if (index_articleId??)>
${prefixName?string('', 'AND ')} :index_articleId_value AS ARTICLE_ID
<#assign prefixName = false>
</#if>
<#if (index_authorPersonCode??)>
${prefixName?string('', 'AND ')} :index_authorPersonCode_value AS AUTHOR_PERSON_CODE
<#assign prefixName = false>
</#if>
<#if (index_authorPersonId??)>
${prefixName?string('', 'AND ')} :index_authorPersonId_value AS AUTHOR_PERSON_ID
<#assign prefixName = false>
</#if>
<#if (index_batchNo??)>
...
${prefixName?string('', 'AND ')} :index_checkPersonCode_value AS CHECK_PERSON_CODE
<#assign prefixName = false>
</#if>
<#if (index_checkPersonId??)>
${prefixName?string('', 'AND ')} :index_checkPersonId_value AS CHECK_PERSON_ID
<#assign prefixName = false>
</#if>
<#if (index_content??)>
...
${prefixName?string('', 'AND ')} :index_departmentCodes_value AS DEPARTMENT_CODES
<#assign prefixName = false>
</#if>
<#if (index_departmentIds??)>
${prefixName?string('', 'AND ')} :index_departmentIds_value AS DEPARTMENT_IDS
<#assign prefixName = false>
</#if>
<#if (index_endDate??)>
...
<#if (index_intro??)>
${prefixName?string('', 'AND ')} :index_intro_value AS INTRO
<#assign prefixName = false>
</#if>
<#if (index_jsonData??)>
...
<#if (index_orgCodes??)>
${prefixName?string('', 'AND ')} :index_orgCodes_value AS ORG_CODES
<#assign prefixName = false>
</#if>
<#if (index_orgIds??)>
${prefixName?string('', 'AND ')} :index_orgIds_value AS ORG_IDS
<#assign prefixName = false>
</#if>
...
<#if (index_pictureUrl??)>
${prefixName?string('', 'AND ')} :index_pictureUrl_value AS PICTURE_URL
<#assign prefixName = false>
</#if>
<#if (index_recom??)>
${prefixName?string('', 'AND ')} :index_recom_value AS RECOM
<#assign prefixName = false>
</#if>
<#if (index_releaseDate??)>
${prefixName?string('', 'AND ')} :index_releaseDate_value AS RELEASE_DATE
<#assign prefixName = false>
</#if>
<#if (index_siteCode??)>
...
${prefixName?string('', 'AND ')} :index_sourcesCode_value AS SOURCES_CODE
<#assign prefixName = false>
</#if>
<#if (index_stateCode??)>
...
<#if (index_title??)>
${prefixName?string('', 'AND ')} :index_title_value AS TITLE
<#assign prefixName = false>
</#if>
<#if (index_version??)>
...
<#assign prefixName = true>
<#if (index_articleId??)>
${prefixName?string('', ', ')}A.ARTICLE_ID = B.ARTICLE_ID
<#assign prefixName = false>
</#if>
<#if (index_authorPersonCode??)>
...
<#if (index_intro??)>
${prefixName?string('', ', ')}A.INTRO = B.INTRO
<#assign prefixName = false>
</#if>
<#if (index_jsonData??)>
...
<#if (index_recom??)>
${prefixName?string('', ', ')}A.RECOM = B.RECOM
<#assign prefixName = false>
</#if>
<#if (index_releaseDate??)>
${prefixName?string('', ', ')}A.RELEASE_DATE = B.RELEASE_DATE
<#assign prefixName = false>
</#if>
<#if (index_siteCode??)>
