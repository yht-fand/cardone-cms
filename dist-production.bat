...
xcopy provider\target\cardone-cms-provider-*.jar dist\production\provider /Y/C/R/I
...
xcopy consumer\target\cardone-cms-consumer-*.jar dist\production\consumer /Y/C/R/I
pause