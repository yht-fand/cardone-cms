...
cp -rf provider/run*.bat dist/$1/provider
cp -rf provider/run*.sh dist/$1/provider
cp provider/target/cardone-cms-*.jar dist/$1/provider
...
cp -rf consumer/run*.bat dist/$1/consumer
cp -rf consumer/run*.sh dist/$1/consumer
cp -rf consumer/target/cardone-cms-*.jar dist/$1/consumer