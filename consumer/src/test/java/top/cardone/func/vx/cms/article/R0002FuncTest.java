...
public class R0002FuncTest {
    @Value("http://localhost:${server.port:8765}/${server.context-path:}/vx/cms/article/r0002.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/cms/article/R0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/cms/article/R0002FuncTest.func.output.json")
