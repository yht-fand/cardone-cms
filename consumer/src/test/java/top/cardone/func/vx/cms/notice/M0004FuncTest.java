...
public class M0004FuncTest {
    @Value("http://localhost:${server.port:8765}${server.context-path:}/vx/cms/notice/m0004.json")
    private String funcUrl;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/cms/notice/M0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/resources/top/cardone/func/vx/cms/notice/M0004FuncTest.func.output.json")
