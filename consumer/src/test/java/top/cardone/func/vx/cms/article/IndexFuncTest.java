...
public class IndexFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/IndexFuncTest.func.output.json")
