...
public class D0002FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/D0002FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/D0002FuncTest.func.output.json")
