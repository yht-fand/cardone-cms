...
public class D0004FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/D0004FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/D0004FuncTest.func.output.json")
