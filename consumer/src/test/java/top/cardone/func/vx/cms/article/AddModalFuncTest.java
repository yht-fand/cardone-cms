...
public class AddModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/AddModalFuncTest.func.output.json")
