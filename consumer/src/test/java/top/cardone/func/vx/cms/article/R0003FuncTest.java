...
public class R0003FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/R0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/R0003FuncTest.func.output.json")
