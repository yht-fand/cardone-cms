...
public class IndexFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/cms/notice/index.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/cms/notice/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/cms/notice/IndexFuncTest.func.output.json")
