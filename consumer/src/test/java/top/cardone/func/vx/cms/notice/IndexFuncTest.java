...
public class IndexFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/IndexFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/IndexFuncTest.func.output.json")
