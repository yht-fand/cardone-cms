...
public class M0001FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/M0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/M0001FuncTest.func.output.json")
