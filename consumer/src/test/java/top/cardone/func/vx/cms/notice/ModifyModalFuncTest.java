...
public class ModifyModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/ModifyModalFuncTest.func.output.json")
