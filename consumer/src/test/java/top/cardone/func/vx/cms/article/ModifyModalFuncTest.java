...
public class ModifyModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/ModifyModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/article/ModifyModalFuncTest.func.output.json")
