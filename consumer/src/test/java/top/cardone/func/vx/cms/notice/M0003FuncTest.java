...
public class M0003FuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/M0003FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/M0003FuncTest.func.output.json")
