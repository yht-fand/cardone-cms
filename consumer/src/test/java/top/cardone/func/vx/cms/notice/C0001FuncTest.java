...
public class C0001FuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/cms/notice/c0001.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/cms/notice/C0001FuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/cms/notice/C0001FuncTest.func.output.json")
