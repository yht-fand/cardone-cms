...
public class AddModalFuncTest {
    ...
    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("${app.root}/src/test/java/top/cardone/func/vx/cms/notice/AddModalFuncTest.func.output.json")
