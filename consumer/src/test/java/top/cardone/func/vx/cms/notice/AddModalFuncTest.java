...
public class AddModalFuncTest {
    @Value("http://localhost:${server.port:8765}${server.servlet.context-path:}/vx/cms/notice/addModal.json")
    private String funcUrl;

    @Value("file:src/test/resources/top/cardone/func/vx/cms/notice/AddModalFuncTest.func.input.json")
    private Resource funcInputResource;

    @Value("file:src/test/resources/top/cardone/func/vx/cms/notice/AddModalFuncTest.func.output.json")
