...
public class ArticleController {
	 ...
	 * /c0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/c0001.input.preValidate.json")
	private String c0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0001.input.json")
	private String c0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0001.input.postValidate.json")
	...
	public Object c0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(ArticleService.class).insertByNotExistsCache(inputMap);
	 ...
	 * /c0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/c0002.input.preValidate.json")
	private String c0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0002.input.json")
	private String c0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0002.input.postValidate.json")
	 ...
	 * /c0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/c0003.input.preValidate.json")
	private String c0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0003.input.json")
	private String c0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0003.input.postValidate.json")
	 ...
	 * /c0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/c0004.input.preValidate.json")
	private String c0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0004.input.json")
	private String c0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/c0004.input.postValidate.json")
	 ...
	 * /d0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/d0001.input.preValidate.json")
	...
	@Value("${app.root}/config/api/vx/cms/article/d0001.input.postValidate.json")
	...
	public Object d0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(ArticleService.class).deleteByIdsCache(inputMap);
	 ...
	 * /d0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/d0002.input.preValidate.json")
	private String d0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/d0002.input.json")
	private String d0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/d0002.input.postValidate.json")
	 ...
	 * /d0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/d0003.input.preValidate.json")
	private String d0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/d0003.input.json")
	private String d0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/d0003.input.postValidate.json")
	 ...
	 * /d0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/d0004.input.preValidate.json")
	private String d0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/d0004.input.json")
	private String d0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/d0004.input.postValidate.json")
	 ...
	 * /m0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/m0001.input.preValidate.json")
	private String m0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0001.input.json")
	private String m0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0001.input.postValidate.json")
	private String m0001InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0001.output.json")
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(ArticleService.class).findOne(inputMap);
	 ...
	 * /m0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/m0002.input.preValidate.json")
	private String m0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0002.input.json")
	private String m0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0002.input.postValidate.json")
	private String m0002InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0002.output.json")
	 ...
	 * /m0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/m0003.input.preValidate.json")
	private String m0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0003.input.json")
	private String m0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0003.input.postValidate.json")
	private String m0003InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0003.output.json")
	 ...
	 * /m0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/m0004.input.preValidate.json")
	private String m0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0004.input.json")
	private String m0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0004.input.postValidate.json")
	private String m0004InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/m0004.output.json")
	 ...
	 * /r0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/r0001.input.preValidate.json")
	private String r0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0001.input.json")
	private String r0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0001.input.postValidate.json")
	private String r0001InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0001.output.json")
	...
	public Object r0001Json(HttpServletRequest request) {
		...
		Page<Map<String, Object>> page = ApplicationContextHolder.getBean(ArticleService.class).page(inputMap);
	 ...
	 * /r0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/r0002.input.preValidate.json")
	private String r0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0002.input.json")
	private String r0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0002.input.postValidate.json")
	private String r0002InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0002.output.json")
	 ...
	 * /r0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/r0003.input.preValidate.json")
	private String r0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0003.input.json")
	private String r0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0003.input.postValidate.json")
	private String r0003InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0003.output.json")
	 ...
	 * /r0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/r0004.input.preValidate.json")
	private String r0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0004.input.json")
	private String r0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0004.input.postValidate.json")
	private String r0004InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/r0004.output.json")
	 ...
	 * /u0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/u0001.input.preValidate.json")
	private String u0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/u0001.input.json")
	private String u0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/u0001.input.postValidate.json")
	...
	public Object u0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(ArticleService.class).updateCache(inputMap);
	 ...
	 * /u0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/u0002.input.preValidate.json")
	...
	@Value("${app.root}/config/api/vx/cms/article/u0002.input.postValidate.json")
	 ...
	 * /u0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/u0003.input.preValidate.json")
	private String u0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/u0003.input.json")
	private String u0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/u0003.input.postValidate.json")
	 ...
	 * /u0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/u0004.input.preValidate.json")
	private String u0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/u0004.input.json")
	private String u0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/u0004.input.postValidate.json")
	 ...
	 * /addModal.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/addModal.input.preValidate.json")
	private String addModalInputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/addModal.input.json")
	private String addModalInputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/addModal.input.postValidate.json")
	private String addModalInputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/addModal.output.json")
	...
	public Object addModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(ArticleService.class).findOneByArticleId(inputMap);
	 ...
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/modifyModal.input.preValidate.json")
	private String modifyModalInputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/modifyModal.input.json")
	private String modifyModalInputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/modifyModal.input.postValidate.json")
	private String modifyModalInputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/modifyModal.output.json")
	 ...
	 * /index.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/article/index.input.preValidate.json")
	private String indexInputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/index.input.json")
	private String indexInputJson;
	
	@Value("${app.root}/config/api/vx/cms/article/index.input.postValidate.json")
	private String indexInputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/article/index.output.json")
