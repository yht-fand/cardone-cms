...
public class ArticleController {
    ...
    public Object c0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ArticleService.class).insertByNotExistsCache(input));
    }
    /** /c0001.json end **/
    ...
    public Object d0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ArticleService.class).deleteByIdsCache(input));
    }
    /** /d0001.json end **/
    ...
    public Object m0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ArticleService.class).findOne(input));
    }
    /** /m0001.json end **/
    ...
    public Object r0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ArticleService.class).page(input));
    }
    /** /r0001.json end **/
    ...
    public Object u0001Json(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ArticleService.class).updateCache(input));
    }
    /** /u0001.json end **/
    ...
    public Object addModalJson(HttpServletRequest request) {
        return ApplicationContextHolder.getBean(WebSupport.class).func(request,
                (Func1<Object, Object>) input -> ApplicationContextHolder.getBean(ArticleService.class).findOneByArticleId(input));
    }
    /** /addModal.json end **/
