...
public class ArticleController {
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(ArticleService.class).findOne(inputMap);
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(ArticleService.class).findOneByArticleId(inputMap.get("articleId"));
