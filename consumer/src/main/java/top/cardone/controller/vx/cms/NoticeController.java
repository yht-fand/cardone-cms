...
public class NoticeController {
	 ...
	 * /c0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/c0001.input.preValidate.json")
	private String c0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0001.input.json")
	private String c0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0001.input.postValidate.json")
	...
	public Object c0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(NoticeService.class).insertByNotExistsCache(inputMap);
	 ...
	 * /c0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/c0002.input.preValidate.json")
	private String c0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0002.input.json")
	private String c0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0002.input.postValidate.json")
	 ...
	 * /c0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/c0003.input.preValidate.json")
	private String c0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0003.input.json")
	private String c0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0003.input.postValidate.json")
	 ...
	 * /c0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/c0004.input.preValidate.json")
	private String c0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0004.input.json")
	private String c0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/c0004.input.postValidate.json")
	 ...
	 * /d0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/d0001.input.preValidate.json")
	private String d0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/d0001.input.json")
	private String d0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/d0001.input.postValidate.json")
	...
	public Object d0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(NoticeService.class).deleteByIdsCache(inputMap);
	 ...
	 * /d0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/d0002.input.preValidate.json")
	private String d0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/d0002.input.json")
	private String d0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/d0002.input.postValidate.json")
	 ...
	 * /d0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/d0003.input.preValidate.json")
	private String d0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/d0003.input.json")
	private String d0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/d0003.input.postValidate.json")
	 ...
	 * /d0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/d0004.input.preValidate.json")
	...
	@Value("${app.root}/config/api/vx/cms/notice/d0004.input.postValidate.json")
	 ...
	 * /m0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/m0001.input.preValidate.json")
	private String m0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0001.input.json")
	private String m0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0001.input.postValidate.json")
	private String m0001InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0001.output.json")
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(NoticeService.class).findOne(inputMap);
	 ...
	 * /m0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/m0002.input.preValidate.json")
	private String m0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0002.input.json")
	private String m0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0002.input.postValidate.json")
	private String m0002InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0002.output.json")
	 ...
	 * /m0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/m0003.input.preValidate.json")
	private String m0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0003.input.json")
	private String m0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0003.input.postValidate.json")
	private String m0003InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/m0003.output.json")
	 ...
	 * /m0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/m0004.input.preValidate.json")
	...
	@Value("${app.root}/config/api/vx/cms/notice/m0004.input.postValidate.json")
	 ...
	 * /r0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/r0001.input.preValidate.json")
	private String r0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0001.input.json")
	private String r0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0001.input.postValidate.json")
	private String r0001InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0001.output.json")
	...
	public Object r0001Json(HttpServletRequest request) {
		...
		Page<Map<String, Object>> page = ApplicationContextHolder.getBean(NoticeService.class).page(inputMap);
	 ...
	 * /r0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/r0002.input.preValidate.json")
	private String r0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0002.input.json")
	private String r0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0002.input.postValidate.json")
	private String r0002InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0002.output.json")
	 ...
	 * /r0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/r0003.input.preValidate.json")
	private String r0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0003.input.json")
	private String r0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0003.input.postValidate.json")
	private String r0003InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0003.output.json")
	 ...
	 * /r0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/r0004.input.preValidate.json")
	private String r0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0004.input.json")
	private String r0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0004.input.postValidate.json")
	private String r0004InputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/r0004.output.json")
	 ...
	 * /u0001.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/u0001.input.preValidate.json")
	private String u0001InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0001.input.json")
	private String u0001InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0001.input.postValidate.json")
	...
	public Object u0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(NoticeService.class).updateCache(inputMap);
	 ...
	 * /u0002.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/u0002.input.preValidate.json")
	private String u0002InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0002.input.json")
	private String u0002InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0002.input.postValidate.json")
	 ...
	 * /u0003.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/u0003.input.preValidate.json")
	private String u0003InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0003.input.json")
	private String u0003InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0003.input.postValidate.json")
	 ...
	 * /u0004.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/u0004.input.preValidate.json")
	private String u0004InputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0004.input.json")
	private String u0004InputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/u0004.input.postValidate.json")
	 ...
	 * /addModal.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/addModal.input.preValidate.json")
	...
	@Value("${app.root}/config/api/vx/cms/notice/addModal.input.postValidate.json")
	private String addModalInputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/addModal.output.json")
	...
	public Object addModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(NoticeService.class).findOneByNoticeId(inputMap);
	 ...
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/modifyModal.input.preValidate.json")
	private String modifyModalInputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/modifyModal.input.json")
	private String modifyModalInputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/modifyModal.input.postValidate.json")
	private String modifyModalInputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/modifyModal.output.json")
	 ...
	 * /index.json begin
	 **xx/
	@Value("${app.root}/config/api/vx/cms/notice/index.input.preValidate.json")
	private String indexInputPreValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/index.input.json")
	private String indexInputJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/index.input.postValidate.json")
	private String indexInputPostValidateJson;
	
	@Value("${app.root}/config/api/vx/cms/notice/index.output.json")
