...
public class NoticeController {
	...
	public Object m0001Json(HttpServletRequest request) {
		...
		Object returnData = ApplicationContextHolder.getBean(NoticeService.class).findOne(inputMap);
	...
	public Object modifyModalJson(HttpServletRequest request) {
		...
		Map<String, Object> returnData = ApplicationContextHolder.getBean(NoticeService.class).findOneByNoticeId(inputMap.get("noticeId"));
