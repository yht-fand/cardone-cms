 ...
 */
@Log4j2
@Component("/vx/cms/article/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String articleId = MapUtils.getString(inputMap, "articleId");

        if (StringUtils.isBlank(articleId)) {
            throw new CodeException("文章标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(ArticleService.class).findOneByArticleId(newInputMap);
