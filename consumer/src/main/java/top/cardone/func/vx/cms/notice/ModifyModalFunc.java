 ...
 */
@Log4j2
@Component("/vx/cms/notice/modifyModal.json")
public class ModifyModalFunc implements Func1<Object, Map<String, Object>> {
    ...
    private void validate(Map<String, Object> inputMap) {
        String noticeId = MapUtils.getString(inputMap, "noticeId");

        if (StringUtils.isBlank(noticeId)) {
            throw new CodeException("公告标识不能为空值!");
        }
    }
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Map<String, Object> outputMap = ApplicationContextHolder.getBean(NoticeService.class).findOneByNoticeId(newInputMap);
