 ...
 */
@Log4j2
@Component("/vx/cms/notice/r0004.json")
public class R0004Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> noticePage = ApplicationContextHolder.getBean(NoticeService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(noticePage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, noticePage.getTotalElements());
    }
}