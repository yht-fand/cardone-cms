 ...
 */
@Log4j2
@Component("/vx/cms/article/r0001.json")
public class R0001Func implements Func1<Object, Map<String, Object>> {
    ...
    public Object func(Map<String, Object> inputMap) {
        ...
        Page<Map<String, Object>> articlePage = ApplicationContextHolder.getBean(ArticleService.class).page(newInputMap);
        ...
        List<Map<String, Object>> newContent = top.cardone.context.util.ListUtils.newArrayList(articlePage.getContent(), outputTable);

        return ApplicationContextHolder.getBean(PageSupport.class).newMap(newContent, inputMap, articlePage.getTotalElements());
    }
}